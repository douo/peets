...
class MediaCertification(Enum):
    ...
    def __init__(self, country: Country, certification: str, possible_notations: list[str]) -> None:
...
class MediaFileType(Enum):
  ...
  @classmethod
  def from_media_artwork_type(cls: type[MediaFileType], a_type: MediaArtworkType) -> MediaFileType:
